...
//Viet Thai -------end------------
    ...
    public Account getAccountByPID(String id) {
        String query = "select * from accounts \n"
                + "where uID = ?";
        try {
            conn = new DBContext().connection;
    ...
    public void editAccount(String user, String pass, int isSell, int isAdmin) {
        // Them vao de edit account
